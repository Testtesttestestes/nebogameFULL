...
namespace Core.Application.Update.Common
{
	...
	public abstract class AbstractAppUpdateRecommended : IAppUpdateOperation, IDisposable
	{
		...
		{
		/* --- GHIDRA: Dispose ---
		void Core_Application_Update_Common_AbstractAppUpdateRecommended__Dispose
		...
		*/
		...
		{
		/* --- GHIDRA: .ctor ---
		void Core_Application_Update_Common_AbstractAppUpdateRecommended___ctor
		...
		
		{
		  ...
		  if (DAT_ram_00a5a802 == '\0') {
		    ...
		    Mono_Security_ASN1__get_Item(&StringLiteral_16801);
		    Mono_Security_ASN1__get_Item(&StringLiteral_4352);
		    DAT_ram_00a5a802 = '\x01';
		  }
		  ...
		  *(undefined4 *)(param1_00 + 0x18) = uVar1;
		  uVar1 = func_ii_7508(StringLiteral_4352,1,0,1,0,0,0,0);
		  *(undefined4 *)(param1_00 + 0x1c) = uVar1;
		  ...
		  uVar1 = func_ii_7508(StringLiteral_16801,1,0,1,0,0,0,0);
		  *(undefined4 *)(param1_02 + 8) = uVar1;
		  ...
		  if (param1 != (int *)0x0) {
		    UI_Windows_BaseDialogWindow_BaseDialogWindowArgs_DialogWindowButton_ButtonInvoker_object____ctor
		              (uVar1,param1,*(undefined4 *)(*param1 + 0x114),0);
