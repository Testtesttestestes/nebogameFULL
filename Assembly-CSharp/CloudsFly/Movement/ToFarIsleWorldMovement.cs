...
namespace CloudsFly.Movement
{
	...
	// ================= UNMATCHED GHIDRA CODE =================
		...
		/* --- GHIDRA: get_Type ---
		void CloudsFly_Movement_ToFarIsleWorldMovement__get_Type
		...
		
		{
		  ...
		  if (DAT_ram_00a596a0 == '\0') {
		    ...
		    Mono_Security_ASN1__get_Item
		              (&Method_CloudsFly_Movement_ToFarIsleWorldMovement___c__DisplayClass2_0__Move_b__0__);
		    Mono_Security_ASN1__get_Item
		              (&CloudsFly_Movement_ToFarIsleWorldMovement___c__DisplayClass2_0_TypeInfo);
		    Mono_Security_ASN1__get_Item(&UnityEngine_Vector3___TypeInfo);
		    DAT_ram_00a596a0 = '\x01';
		  }
		  ...
		  *(float *)(iVar4 + 0x2c) = fVar8 + 50.0;
		  ...
		  DG_Tweening_Color2__op_Multiply
		            (uVar5,iVar2,
		             Method_CloudsFly_Movement_ToFarIsleWorldMovement___c__DisplayClass2_0__Move_b__0__,0);
