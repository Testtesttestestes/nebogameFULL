...
namespace ServicesNamespace
{
	...
	public class SocialService : AbstractService
	{
		...
		int * ServicesNamespace_SocialService__GetGiftsStatus
		...
		
		{
		  ...
		  if (DAT_ram_00a5b7ae == '\0') {
		    Mono_Security_ASN1__get_Item(&System_Action_SrvCommand__IMessage__TypeInfo);
		    Mono_Security_ASN1__get_Item(&Protocol_Social_ProtoSendGiftCmd_TypeInfo);
		    Mono_Security_ASN1__get_Item(&Protocol_Social_SocialCommands_TypeInfo);
		  ...
		  if (iVar1 != 0) {
		    ...
		    iVar1 = unnamed_function_1417(Protocol_Social_ProtoSendGiftCmd_TypeInfo);
		    ...
		    *(undefined4 *)(iVar1 + 0xc) = param2;
		    ...
		    local_8 = 0x2ffffffff;
		    local_c = Protocol_Social_SocialCommands_TypeInfo;
		...
		*/
		...
		{
		/* --- GHIDRA: SendGift ---
		int * ServicesNamespace_SocialService__SendGift(int *param1,undefined4 param2,undefined4 param3)
		
		{
		  ...
		  if (DAT_ram_00a5b7af == '\0') {
		    Mono_Security_ASN1__get_Item(&System_Action_SrvCommand__IMessage__TypeInfo);
		    Mono_Security_ASN1__get_Item(&Protocol_Social_ProtoOnRateUsCmd_TypeInfo);
		    Mono_Security_ASN1__get_Item(&Protocol_Social_SocialCommands_TypeInfo);
		    Mono_Security_ASN1__get_Item(&Method_Core_Net_SrvCommand_SetCallback_ProtoDefaultAns___);
		    Mono_Security_ASN1__get_Item(&Core_Net_SrvCommand_TypeInfo);
		    DAT_ram_00a5b7af = '\x01';
		  }
		  if (*(int *)(Core_Net_SrvCommand_TypeInfo + 0x74) == 0) {
		    func_ii_306000(Core_Net_SrvCommand_TypeInfo);
		  }
		  ...
		  if (iVar1 != 0) {
		    (**(code **)((ulonglong)*(uint *)(*param1_00 + 0x110) * 4))
		              (param1_00,*(undefined4 *)(*param1_00 + 0x114));
		    iVar1 = unnamed_function_1417(Protocol_Social_ProtoOnRateUsCmd_TypeInfo);
		    *(undefined4 *)(iVar1 + 0xc) = param2;
		    uVar2 = (**(code **)((ulonglong)*(uint *)(*param1 + 0xe0) * 4))
		                      (param1,*(undefined4 *)(*param1 + 0xe4));
		    if (*(int *)(Core_Net_SrvCommand_TypeInfo + 0x74) == 0) {
	...
	// ================= UNMATCHED GHIDRA CODE =================
		...
		int * ServicesNamespace_SocialService__get_ServiceId(int *param1,undefined4 param2)
		
		{
		  ...
		  if (DAT_ram_00a5b7ad == '\0') {
		    Mono_Security_ASN1__get_Item(&System_Action_SrvCommand__IMessage__TypeInfo);
		    Mono_Security_ASN1__get_Item(&Protocol_Social_SocialCommands_TypeInfo);
		    Mono_Security_ASN1__get_Item(&Method_Core_Net_SrvCommand_SetCallback_ProtoGetGiftsStatusAns___);
		    Mono_Security_ASN1__get_Item(&Core_Net_SrvCommand_TypeInfo);
		    DAT_ram_00a5b7ad = '\x01';
		  }
		  if (*(int *)(Core_Net_SrvCommand_TypeInfo + 0x74) == 0) {
		    func_ii_306000(Core_Net_SrvCommand_TypeInfo);
		  }
		  ...
		  if (iVar1 != 0) {
		    ...
		    *(undefined4 *)(iVar1 + 0x14) = uVar2;
		    ...
		    System_Runtime_CompilerServices_AsyncVoidMethodBuilder__AwaitUnsafeOnCompleted_UniTask_Awaiter_bool___BossCaptainViewMediator__SetupView_d__8_
		              (uVar2,param1,*(undefined4 *)(*param1 + 0xec),0);
		    Core_Data_Spells_SpellData__Create_object_
		              (iVar1,uVar2,Method_Core_Net_SrvCommand_SetCallback_ProtoGetGiftsStatusAns___);
		    Core_Net_AbstractService__LogCommandAnswer(param1,iVar1,0);
		  }
		  return param1_00;
		}
