...
namespace Gameplay.Inventory.View.Chest
{
	...
	public class InventoryGridWithCategoriesParams : GridParams
	{
		...
		{
		/* --- GHIDRA: .ctor ---
		void Gameplay_Inventory_View_Chest_InventoryGridWithCategoriesParams___ctor
		               (int param1,undefined4 param2)
		
		{
		  undefined4 uVar1;
		  
		  if (DAT_ram_00a5a104 == '\0') {
		    Mono_Security_ASN1__get_Item
		              (&
		               Method_Com_TheFallenGames_OSA_CustomAdapters_GridView_CellGroupViewsHolder_ArtifactCellViewHolder__CollectViews__
		              );
