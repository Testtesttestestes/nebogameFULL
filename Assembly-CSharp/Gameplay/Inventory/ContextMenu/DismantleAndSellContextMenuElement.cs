...
namespace Gameplay.Inventory.ContextMenu
{
	...
	public class DismantleAndSellContextMenuElement : AbstractArtifactContextMenuElement
	{
		...
		{
		/* --- GHIDRA: Handle ---
		uint Gameplay_Inventory_ContextMenu_DismantleAndSellContextMenuElement__Handle
		...
		code_r0x811dbfb3:
		  ...
		  iVar5 = Core_Data_ArtifactData__get_IsTemporaryWithCriticalLifetime(uVar2,0);
		  if (iVar5 == 0) {
		    uVar6 = 0;
		    iVar5 = *param2;
		    if (*(ushort *)(iVar5 + 0xb6) != 0) {
		...
		code_r0x811dc20f:
		        iVar5 = (**(code **)((ulonglong)*puVar1 * 4))(param2,puVar1[1]);
		        uVar6 = (*(byte *)(*(int *)(iVar5 + 0xc) + 0x11) & 0x10) >> 4;
		      }
		      else {
		        uVar6 = 0;
		      }
	...
	// ================= UNMATCHED GHIDRA CODE =================
		...
		/* --- GHIDRA: get_ActionId ---
		void Gameplay_Inventory_ContextMenu_DismantleAndSellContextMenuElement__get_ActionId
		               (undefined4 param1,int *param2,undefined4 param3)
		
		{
		  ...
		  if (DAT_ram_00a5a19b == '\0') {
		    Mono_Security_ASN1__get_Item(&Gameplay_Inventory_View_IArtifactView_TypeInfo);
		    Mono_Security_ASN1__get_Item(&Core_Gameplay_IGame_TypeInfo);
		    DAT_ram_00a5a19b = '\x01';
		  }
		  iVar6 = *param2;
		...
		code_r0x811dbdcd:
		    ...
		    Gameplay_ArtifactDrop_Control_ArtifactDropController__EquipArtifact(uVar3,uVar4,1,0,0);
		    return;
		  }
		  if (DAT_ram_00a6456f == '\0') {
		    Mono_Security_ASN1__get_Item(&Core_Gameplay_Game_TypeInfo);
		...
		code_r0x811dbf01:
		  uVar4 = (**(code **)((ulonglong)*puVar2 * 4))(param2,puVar2[1]);
		  Core_Gameplay_Managers_Inventory_InventoryManager__Equip(uVar3,uVar4,1,0,0);
		  return;
		}
		*/
