...
namespace Gameplay.Inventory.ContextMenu
{
	...
	public class MoveToShopContextMenuElement : AbstractArtifactContextMenuElement
	{
		...
		{
		/* --- GHIDRA: Validate ---
		void Gameplay_Inventory_ContextMenu_MoveToShopContextMenuElement__Validate
		...
		code_r0x811df10a:
		  ...
		  Gameplay_Shop_ShopController__RequestShopItemsResultHandler(param1_01,param2_00,0,0);
		  return;
		}
		*/
	...
	// ================= UNMATCHED GHIDRA CODE =================
		...
		/* --- GHIDRA: get_ActionId ---
		uint Gameplay_Inventory_ContextMenu_MoveToShopContextMenuElement__get_ActionId
		               (undefined4 param1,int *param2,undefined4 param3)
		...
		code_r0x811def68:
		    ...
		    iVar6 = *(int *)(*(int *)(iVar6 + 0x14) + 0x20);
		    if (iVar6 == 0) {
		      uVar1 = 0;
		    }
		    else {
		      uVar1 = 0;
		      iVar6 = Gameplay_Isles_Base_Model_BaseIsleModel__GetBuildingLevel
		                        (*(undefined4 *)(iVar6 + 0x10),3,&local_4,0);
		      if (iVar6 != 0) {
		        iVar6 = Newtonsoft_Json_Converters_XDeclarationWrapper__get_Encoding(local_4,0);
		        uVar1 = (uint)(iVar6 != 0);
		      }
		    }
		  }
