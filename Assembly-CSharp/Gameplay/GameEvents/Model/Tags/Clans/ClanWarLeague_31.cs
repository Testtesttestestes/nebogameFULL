...
namespace Gameplay.GameEvents.Model.Tags.Clans
{
	...
	public class ClanWarLeague_31 : AbstractTag
	{
		...
		{
		/* --- GHIDRA: .ctor ---
		int Gameplay_GameEvents_Model_Tags_Clans_ClanWarLeague_31___ctor(int *param1,undefined4 param2)
	...
	// ================= UNMATCHED GHIDRA CODE =================
		...
		/* --- GHIDRA: get_LeagueId ---
		int Gameplay_GameEvents_Model_Tags_Clans_ClanWarLeague_31__get_LeagueId
		...
		
		{
		  ...
		  if (DAT_ram_00a574fa == '\0') {
		    Mono_Security_ASN1__get_Item(&Core_Dict_IDictProvider_TypeInfo);
		    Mono_Security_ASN1__get_Item(&StringLiteral_25049);
		    DAT_ram_00a574fa = '\x01';
		  }
		  ...
		  if (iVar2 == 0) {
		    ...
		    *param4 = uVar1;
		    iVar3 = System_Collections_CollectionBase___ctor(param2,StringLiteral_25049,0);
		    if (iVar3 == 0) {
		      return iVar2;
		    }
		...
		code_r0x80d9a3d7:
		    ...
		    uVar1 = Core_Extensions_Dict_DictExt__GetClanPrizesByKindId(uVar1,iVar5,0);
		    uVar1 = Core_Extensions_Dict_ClanCultDicExt__GetTitle(uVar1,0);
		  }
		  *param4 = uVar1;
		  return iVar2;
		}
